...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function MascotSection(props) {
      const renderSlot = props && typeof props.renderSlot === "function" ? props.renderSlot : () => jsx("div", null);
      return jsx("div", { style: { display: "flex", flexDirection: "column", width: "100%" }, children: renderSlot("settings.mascot.item", {}) });
    }
