"""Slice raw-batch2 generated poses into review webp + contact sheet.
Output goes to output/imagegen/review/ ONLY — never touches assets/generated."""
from pathlib import Path

from PIL import Image, ImageDraw, ImageFont

ROOT = Path(__file__).resolve().parents[1]
SOURCE = ROOT / "output" / "imagegen" / "raw-batch2"
OUTPUT = ROOT / "output" / "imagegen" / "review"
